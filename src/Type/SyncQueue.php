...
use Finko\QueueBundle\Event\EventsList;
use Finko\QueueBundle\Event\JobExceptionOccurred;
use Finko\QueueBundle\Event\JobFailed;
use Finko\QueueBundle\Event\JobProcessed;
use Finko\QueueBundle\Event\JobProcessing;
use Finko\QueueBundle\Exception\ManuallyFailedException;
use Finko\QueueBundle\Job\JobsInterface;
use Finko\QueueBundle\Job\SyncJob;
 ...
 * Class SyncQueue
 *
 * @package Finko\QueueBundle\Type
 */
